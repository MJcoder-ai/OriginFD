...
function generateComponents() {
  ...
  const solarPanels = [
    ...
    { brand: "Panasonic", series: "VBHN", wattages: [330, 340, 350, 360] },
    {
      ...
      series: "CS3K",
      wattages: [300, 310, 320, 330, 340],
    },
    { brand: "JinkoSolar", series: "JKM", wattages: [400, 410, 420, 430, 440] },
    {
      brand: "First Solar",
      series: "FS-6",
      wattages: [420, 430, 440, 450, 460],
    },
    {
      brand: "Trina Solar",
      series: "TSM",
      wattages: [380, 390, 400, 410, 420],
    },
  ...
  solarPanels.forEach((panel) => {
    panel.wattages.forEach((wattage, index) => {
      ...
      components.push({
        ...
        efficiency: 0.2 + Math.random() * 0.05,
        dimensions: {
  ...
  const inverters = [
    ...
    { brand: "Enphase", series: "IQ", ratings: [290, 320, 350, 380] },
    {
      brand: "Power-One",
      series: "PVI",
      ratings: [10000, 12500, 15000, 17500],
    },
  ];
  ...
  const batteries = [
    ...
    {
      brand: "Sonnen",
      series: "sonnenBatterie",
      ratings: [5000, 10000, 15000, 20000],
    },
...
const stats = {
  ...
  active_components: allComponents.filter((c) => c.status === "available")
    .length,
...
allComponents.forEach((component) => {
  stats.categories[component.category] =
    (stats.categories[component.category] || 0) + 1;
});
...
console.log(
  "✅ Component seed data generated and saved to components-seed.json",
);
