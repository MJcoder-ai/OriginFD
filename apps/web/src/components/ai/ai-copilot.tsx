    ...
    return [
      {
        ...
        description:
          "I noticed your current layout could be 15% more efficient",
  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I'm your AI assistant. I can help you with component management, project optimization, and much more. What would you like to work on today?",
      timestamp: new Date(),
      actions: [
        {
          id: "get-started",
