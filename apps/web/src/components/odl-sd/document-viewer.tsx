      ...
      <Tabs defaultValue="overview" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.hierarchy.portfolio?.location || "Not specified"}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono bg-muted px-2 py-1 rounded">
                    {document.meta?.versioning?.content_hash?.substring(
                      7,
                      19,
                    ) || "N/A"}
                    ...
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.meta?.timestamps?.updated_at
                      ? new Date(
                          document.meta.timestamps.updated_at,
                        ).toLocaleDateString()
                      : "Not available"}
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.meta?.units?.system || "N/A"} /{" "}
                    {document.meta?.units?.currency || "N/A"}
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="components" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>
                System Components ({document.instances.length})
              </CardTitle>
              <CardDescription>
        ...
        <TabsContent value="connections" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>
                System Connections ({document.connections.length})
              </CardTitle>
              <CardDescription>
                    ...
                    {expandedConnections.has(connection.id) && (
                      <CardContent className="pt-0">
                        <div>
                          ...
                          <div className="space-y-2">
                            {Object.entries(connection.parameters).map(
                              ([key, value]) => (
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.requirements?.functional?.performance_requirements
                      ? Object.keys(
                          document.requirements.functional
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.requirements?.technical?.voltage_level ||
                      "Not specified"}
                  </p>
                </div>
                <div>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {document.requirements?.regulatory?.grid_codes?.map(
                      (code: any) => (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {document.requirements?.regulatory?.safety_standards?.map(
                      (standard: any) => (
                        <Badge
                          key={standard}
                          variant="outline"
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {document.requirements?.regulatory?.environmental_permits
                      ?.length
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      copyToClipboard(JSON.stringify(document, null, 2), "json")
                    }
                  >
                    {copiedTab === "json" ? (
