...
export default function RFQCreationWizard({
    ...
    setFormData((prev) => ({
      ...
      evaluation_criteria: {
        ...
        total_weight: Object.values({
          ...
          (sum, weight) => (field === "total_weight" ? sum : sum + weight),
          0,
        ),
      },
    }));
  ...
  const validateStep = (step: number) => {
    switch (step) {
      ...
      case 3:
        return formData.specifications.every(
          (spec) => spec.category && spec.requirement,
        );
      case 4:
  ...
  const selectedComponentData =
    components?.find(
      (comp: ComponentResponse) => comp.id === formData.component_id,
    ) || selectedComponent;
                ...
                {selectedComponent ? (
                  <div className="p-2 border rounded-md bg-muted">
                    <div className="text-sm font-medium">
                      {
                        selectedComponent.component_management
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateFormData("component_id", value)
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      {components?.map((comp: ComponentResponse) => (
                        <SelectItem key={comp.id} value={comp.id}>
                          ...
                          {
                            comp.component_management?.component_identity
                              ?.part_number
                          }
                        </SelectItem>
                      ))}
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      {
                        selectedComponentData.component_management
                          ?.component_identity?.brand
                      }
                    </div>
                    <div>
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="required_delivery_date">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateFormData("required_delivery_date", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateFormData("response_deadline", e.target.value)
                }
              />
            ...
            <div className="grid gap-4">
              {[
                ...
                },
                {
                  key: "delivery_weight",
                  label: "Delivery",
                  description: "Timeline and logistics",
                },
                {
                  key: "quality_weight",
                  label: "Quality",
                  description: "Product quality and certifications",
                },
                {
                  key: "experience_weight",
                  label: "Experience",
                  description: "Supplier track record",
                },
                {
                  key: "sustainability_weight",
