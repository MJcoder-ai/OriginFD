 ...
 */
export function WarrantyPanel({ deviceInstanceId, warrantyStatus = 'unknown' }: WarrantyPanelProps) {
  ...
  const submitClaim = async () => {
    ...
    try {
      ...
      await apiClient.post(`/components/${deviceInstanceId}/warranty/claims`, formData)
      setClaimDescription('')
      setAttachments([])
    } finally {
      setSubmitting(false)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Manage warranty claims and device swaps</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          />
          <Button variant="outline" onClick={submitSwap} disabled={swapSubmitting}>
