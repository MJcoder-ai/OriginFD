    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Welcome back, {supplierName}</p>
        </div>
                    ...
                    .map((rfq: RFQRequest) => {
                      ...
                      return (
                        <TableRow key={rfq.id}>
                          ...
                          <TableCell>
                            {rfq.budget_range ? (
                              <div className="text-sm">
                                {formatCurrency(rfq.budget_range.min)} - {formatCurrency(rfq.budget_range.max)}
                                <span className="text-muted-foreground block">per unit</span>
                              </div>
                            ) : (
                          ...
                          <TableCell>
                            <Badge variant={getRFQStatusBadgeVariant(rfq.status)}>
                ...
                <TableBody>
                  {supplierBids.map((bid: any) => (
                    <TableRow key={bid.id}>
                      ...
                      <TableCell>
                        <div>
                          <p className="font-medium">{formatCurrency(bid.unit_price)}</p>
                      ...
                      <TableCell>
                        <Badge variant={getRFQStatusBadgeVariant(bid.rfq_status)}>
                  ...
                  {supplierBids.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                        No bids submitted yet. Check the Open RFQs tab to find opportunities.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Keep submitting competitive bids to win contracts!</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p>{selectedRFQ.quantity.toLocaleString()} {selectedRFQ.unit_of_measure}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <Label className="text-sm font-medium text-muted-foreground">Required Delivery</Label>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setBidForm(prev => ({ ...prev, total_price: e.target.value }))}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setBidForm(prev => ({ ...prev, delivery_date: e.target.value }))}
                      />
                    </div>
                    <div>
                      <Label htmlFor="validity_period">Bid Validity (Days)</Label>
                      <Input
                        id="validity_period"
                        type="number"
                        value={bidForm.validity_period_days}
                        onChange={(e) => setBidForm(prev => ({ ...prev, validity_period_days: parseInt(e.target.value) || 30 }))}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setBidForm(prev => ({ ...prev, delivery_terms: e.target.value }))}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setBidForm(prev => ({ ...prev, sustainability_score: e.target.value }))}
                    />
                  </div>
