...
import { Plus, Search, Filter, Grid3x3, Eye, MoreHorizontal, Layers, Map } from 'lucide-react'
import { apiClient } from '@/lib/api-client'
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, LoadingSpinner } from '@originfd/ui'
  ...
  const canvases = [
    {
      ...
      description: 'Medium voltage single-line diagram with protection and control',
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(canvas.status)}`}>
                        {canvas.status}
                      </span>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2 pt-2">
                  <Button 
                    ...
                    variant="outline" 
                    className="flex-1"
                    onClick={() => router.push(`/projects/${projectId}/canvases/${canvas.id}`)}
                  >
