...
import { Plus, Search, Filter, FileText, Download, MoreHorizontal, Eye } from 'lucide-react'
...
export default function ProjectDocumentsPage() {
  ...
  const { data: projectDocuments = [], isLoading: isProjectDocumentsLoading } = useQuery({
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <CardDescription className="text-xs">
                      {doc.document_type || 'ODL-SD'} • {doc.is_primary ? 'Primary' : 'Secondary'}
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${getCategoryColor(document.category)}`}>
                        {document.category}
                      </span>
                    </div>
                  </div>
        ...
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-4">
              Upload your first document to start building your project documentation.
            </p>
            <Button className="gap-2">
              <Plus className="h-4 w-4" />
              Upload Document
