  ...
  if (projectError || documentError) {
    ...
    if (projectError && documentError) {
      if (isForbidden(projectError) || isForbidden(documentError)) {
        title = "Access Denied";
        message =
          "You don't have permission to access this project or its documents. Please contact your administrator.";
        ...
        message =
          "There was an issue loading both the project and its document.";
      }
    } else if (projectError) {
      if (isForbidden(projectError)) {
        title = "Project Access Denied";
        message =
          "You don't have permission to view this project. Please contact your administrator.";
      ...
      if (isForbidden(documentError)) {
        ...
        message =
          "The project exists but its document could not be found. The document may not have been created yet.";
      } else {
        title = "Document Loading Error";
        message =
          "There was an issue loading the project document. You can still view project information.";
      }
    }
        ...
        <div className="text-center">
          ...
          {documentError && !projectError && (
            <p className="text-sm text-muted-foreground mt-2">
              You can still view project information, but document features will
              be unavailable.
            </p>
          )}
        </div>
    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4">
            <div className="p-2 rounded-lg bg-muted">
              {getDomainIcon(
                project?.domain || document?.meta?.domain || "GRID",
              )}
            </div>
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getDomainColor(project?.domain || document?.meta?.domain || "GRID")}`}
                >
                  {project?.domain || document?.meta?.domain}
                </span>
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getScaleBadgeColor(project?.scale || document?.meta?.scale || "COMMERCIAL")}`}
                >
                ...
                <span className="text-sm text-muted-foreground">
                  ...
                  {project?.current_version ||
                    document?.meta?.versioning?.document_version}
                </span>
              </div>
            </div>
          </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    {document?.hierarchy?.portfolio?.location ||
                      "Not specified"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    {document?.hierarchy?.portfolio?.description ||
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-sm text-muted-foreground text-center mb-4">
                  No ODL-SD documents found for this project. Create your first
        ...
        <TabsContent value="components" className="space-y-6">
          ...
          {document?.libraries?.components &&
          document.libraries.components.length > 0 ? (
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {document.libraries.components.map(
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-sm text-muted-foreground text-center mb-4">
                  Start building your project by adding components from the
                  library
                </p>
                <Button onClick={() => setComponentSelectorOpen(true)}>
                  <Grid3x3 className="h-4 w-4 mr-2" />
