        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span className="text-foreground">
              {component.component_management?.component_identity?.brand}{" "}
              {component.component_management?.component_identity?.part_number}
            </span>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                {component.domain && (
                  <Badge variant="outline">{component.domain}</Badge>
                )}
                <span className="text-sm text-muted-foreground">
                  {component.component_management?.component_identity?.rating_w}
                  W
                </span>
              </div>
            </div>
                              ...
                              <p className="font-mono text-sm">
                                {
                                  component.component_management
                                    ?.component_identity?.classification?.unspsc
                                }
                              </p>
                            </div>
                          )}
                          {component.component_management?.component_identity
                            ...
                            <div>
                              ...
                              <p className="font-mono text-sm">
                                {
                                  component.component_management
                                    ?.component_identity?.classification
                                    ?.hs_code
                                }
                              </p>
                            </div>
                          ...
                          {component.component_management?.component_identity
                            ...
                            <div>
                              ...
                              <p className="font-mono text-sm">
                                {
                                  component.component_management
                                    ?.component_identity?.classification?.eclass
                                }
                              </p>
                            </div>
                          )}
                          {component.component_management?.component_identity
                            ...
                            <div>
                              ...
                              <p className="font-mono text-sm">
                                {
                                  component.component_management
                                    ?.component_identity?.classification?.gtin
                                }
                              </p>
                            </div>
                          )}
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Upload a datasheet to extract technical specifications
                      automatically.
                    </p>
                    <div className="mt-6">
                      <Button>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {formatDate(
                            component.component_management?.audit?.created_at ||
                              "",
                          )}
                        </p>
                      </div>
                    ...
                    {component.component_management?.audit?.updated_at !==
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 space-y-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {formatDate(
                              component.component_management?.audit
                                ?.updated_at || "",
                            )}
                          </p>
                        </div>
                ...
                <div className="space-y-2">
                  ...
                  {getAvailableTransitions(
                    ...
                    <Button
                      ...
                      onClick={() =>
                        transitionMutation.mutate({ newStatus: status })
                      }
