...
import { Button, Card, CardContent, CardHeader, CardTitle, CardDescription } from '@originfd/ui'
  ...
  return (
    <div className="space-y-4 p-4">
      <div className="flex gap-4">
        <a href="http://localhost:8001/tools/sdk/typescript" className="underline text-blue-600" target="_blank">Download TypeScript SDK</a>
        <a href="http://localhost:8001/tools/sdk/python" className="underline text-blue-600" target="_blank">Download Python SDK</a>
      </div>
      {tools?.map((tool) => (
