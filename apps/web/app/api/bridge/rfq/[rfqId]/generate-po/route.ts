...
async function fetchRFQData(rfqId: string) {
  ...
  return {
    ...
    unit_of_measure: "pcs",
    description:
      "Procurement of high-efficiency monocrystalline PV modules for 100MW utility-scale solar farm",
...
export async function POST(
  ...
  try {
    ...
    const purchaseOrder: Partial<PurchaseOrder> = {
      ...
      order_details: {
        ...
        requested_delivery_date:
          poData.requested_delivery_date || awardedBid.delivery_date,
      ...
      delivery: {
        estimated_ship_date: new Date(
          new Date(awardedBid.delivery_date).getTime() -
            2 * 24 * 60 * 60 * 1000,
        )
          .toISOString()
          .split("T")[0], // 2 days before delivery
        requested_delivery_date:
          poData.requested_delivery_date || awardedBid.delivery_date,
        confirmed_delivery_date: awardedBid.delivery_date,
      ...
      terms: {
        ...
        return_policy:
          poData.terms?.return_policy || "30-day return for defective products",
        force_majeure_clause: poData.terms?.force_majeure_clause || true,
        dispute_resolution:
          poData.terms?.dispute_resolution ||
          "Arbitration per AAA Commercial Rules",
        governing_law:
          poData.terms?.governing_law || "State Law of Delivery Location",
      ...
      milestones: [
        ...
        },
        {
          ...
          due_date: new Date(
            ...
            .toISOString()
            .split("T")[0], // 30 days before delivery
          status: "pending",
          responsible_party: "supplier",
        },
      ],
    ...
    console.log(
      `Generated PO ${poNumber} from RFQ ${rfqId} award ${poData.award_id}`,
    );
