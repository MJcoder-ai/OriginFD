...
export async function GET(
      ...
      return NextResponse.json({
        ...
        hierarchy: {
          ...
          portfolio: {
            ...
            total_capacity_gw: 0.001,
            description:
              (document.document_data as any)?.description ||
              `${document.project_name} project document`,
        ...
        requirements: {
          functional: {
            ...
            annual_generation_kwh:
              (document.document_data as any)?.annual_generation_kwh || 0,
          },
          technical: {
            grid_connection: true,
          },
  ...
  console.log(
    "Found legacy document for project:",
