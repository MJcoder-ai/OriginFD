...
const mockMediaAssets: MediaAsset[] = [
  {
    ...
    cdn_url:
      "https://cdn.originfd.com/datasheets/jinko_tiger_neo_535w_v2.3.pdf",
    ...
    metadata: {
      ...
      extracted_text:
        "JinkoSolar Tiger Neo 535W Monocrystalline Silicon Photovoltaic Module...",
      extracted_data: {
        power_rating: "535W",
        efficiency: "20.8%",
        warranty: "25 years",
  ...
  },
  {
    ...
    metadata: {
      ...
      extracted_text:
        "ABB TRIO-50.0-TL-OUTD String Inverter Installation Manual...",
      extracted_data: {
        power_rating: "50kW",
