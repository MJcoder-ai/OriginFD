...
def upgrade() -> None:
    ...
    op.add_column('components', sa.Column('lifecycle_stage', sa.String(length=20), nullable=True))
    op.add_column('components', sa.Column('inventory_managed', sa.Boolean(), nullable=True, default=False))
    op.add_column('components', sa.Column('compliance_status', sa.String(length=20), nullable=True))
