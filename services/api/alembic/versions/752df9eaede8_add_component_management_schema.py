...
def upgrade() -> None:
    ...
    sa.Column('document_data', postgresql.JSONB(astext_type=Text()), nullable=False),
    ...
    op.create_index('ix_documents_domain_scale', 'documents', ['domain', 'scale'], unique=False)
    op.create_index(op.f('ix_documents_portfolio_id'), 'documents', ['portfolio_id'], unique=False)
    op.create_index(op.f('ix_documents_tenant_id'), 'documents', ['tenant_id'], unique=False)
    op.create_index('ix_documents_tenant_project', 'documents', ['tenant_id', 'project_name'], unique=False)
    ...
    sa.Column('classification', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    op.create_index(op.f('ix_components_domain'), 'components', ['domain'], unique=False)
    ...
    op.create_index(op.f('ix_components_subcategory'), 'components', ['subcategory'], unique=False)
    op.create_index(op.f('ix_components_tenant_id'), 'components', ['tenant_id'], unique=False)
    ...
    op.create_index('ix_doc_access_document_user', 'document_access', ['document_id', 'user_id'], unique=False)
    op.create_index('ix_doc_access_role_permissions', 'document_access', ['role', 'permissions'], unique=False)
    op.create_index(op.f('ix_document_access_tenant_id'), 'document_access', ['tenant_id'], unique=False)
    ...
    sa.Column('patch_operations', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    op.create_index('ix_doc_versions_document_version', 'document_versions', ['document_id', 'version_number'], unique=False)
    ...
    sa.Column('domain', sa.Enum('PV', 'BESS', 'HYBRID', 'GRID', 'MICROGRID', name='projectdomain'), nullable=False),
    sa.Column('scale', sa.Enum('RESIDENTIAL', 'COMMERCIAL', 'INDUSTRIAL', 'UTILITY', 'HYPERSCALE', name='projectscale'), nullable=False),
    sa.Column('status', sa.Enum('DRAFT', 'ACTIVE', 'UNDER_REVIEW', 'APPROVED', 'IN_CONSTRUCTION', 'OPERATIONAL', 'DECOMMISSIONED', 'CANCELLED', name='projectstatus'), nullable=True),
    ...
    sa.Column('certifications', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    op.create_table('component_management',
    sa.Column('component_id', sa.UUID(), nullable=False),
    sa.Column('version', sa.String(length=10), nullable=False),
    sa.Column('source_documents', postgresql.JSONB(astext_type=Text()), nullable=True),
    sa.Column('tracking_policy', postgresql.JSONB(astext_type=Text()), nullable=True),
    sa.Column('approvals', postgresql.JSONB(astext_type=Text()), nullable=True),
    sa.Column('supplier_chain', postgresql.JSONB(astext_type=Text()), nullable=True),
    sa.Column('order_management', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    op.create_index(op.f('ix_inventory_records_status'), 'inventory_records', ['status'], unique=False)
    ...
    op.create_index(op.f('ix_media_assets_asset_id'), 'media_assets', ['asset_id'], unique=True)
    op.create_index(op.f('ix_media_assets_hash'), 'media_assets', ['hash'], unique=False)
    op.create_index(op.f('ix_media_assets_scope'), 'media_assets', ['scope'], unique=False)
    ...
    op.create_index(op.f('ix_purchase_orders_po_id'), 'purchase_orders', ['po_id'], unique=True)
    ...
    op.create_index(op.f('ix_purchase_orders_waybill'), 'purchase_orders', ['waybill'], unique=False)
    ...
    sa.Column('status', sa.String(length=20), nullable=False),
    sa.Column('handling_units', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    op.create_index(op.f('ix_shipments_waybill'), 'shipments', ['waybill'], unique=False)
