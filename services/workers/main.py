...
def process_document(self, document_id: str, project_id: str):
    ...
    try:
        ...
        if not document_id or not project_id:
            raise PermanentError("Missing required parameters: document_id or project_id")
        ...
        try:
            ...
            logger.info(f"Document {document_id} processed successfully in {processing_duration:.2f}s")
            return result
